...
public class Shop
{
    ...
    private static final int CAR_COST = 7;
    ...
    public void enter(Hunter hunter, String buyOrSell)
    {
        ...
        if (buyOrSell.equals("B") || buyOrSell.equals("b"))
        {
            ...
            System.out.println("If your starting gold is 30; type z after purchasing your choice. ");
    ...
    public void buyItem(String item)
    {
        ...
        {
            System.out.println("Ye' got yourself a " + item + ". Come again soon.");
        }
        else
        {
    ...
    public int getCostOfItem(String item)
    {
        ...
        else if (item.indexOf("W")!=-1||item.indexOf("w")!=-1)
        {
            return WATER_COST;
        }
        else if (item.indexOf("R")!=-1||item.indexOf("r")!=-1)
        {
            return ROPE_COST;
        }
        else if (item.indexOf("M")!=-1||item.indexOf("m")!=-1)
        {
            return MACHETE_COST;
        }
        else if (item.indexOf("H")!=-1||item.indexOf("h")!=-1)
        {
            return HORSE_COST;
        }
        else if (item.indexOf("B")!=-1||item.indexOf("b")!=-1)
        {
            return BOAT_COST;
        }
        else if (item.indexOf("C")!=-1||item.indexOf("c")!=-1){
            return CAR_COST;
        }
        else
        {
